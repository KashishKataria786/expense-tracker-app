  ...
  const fetchTransactions = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_BASE_URL}/api/transaction${query}`,
        {
          headers: {
      ...
      <div className="flex flex-wrap items-center  gap-4  my-2 ">
        ...
        <div className="flex-1 min-w-[200px]">
          ...
          <div className="bg-white">
            <input
              ...
              className="w-full border bg-white border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-red-500 focus:outline-none shadow-sm placeholder-gray-400"
            />
          </div>
        </div>
        ...
        <div className="min-w-[150px]">
          ...
          <select
            ...
            className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-red-500 focus:outline-none shadow-sm bg-white"
          >
      ...
      <div className="bg-white shadow-lg rounded-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
          ...
          <button
            ...
            className="px-6 font-semibold  text-white py-2 bg-blue-500 border border-blue-500 hover:bg-white hover:text-blue-500"
          >
            Add
          </button>
        </div>
